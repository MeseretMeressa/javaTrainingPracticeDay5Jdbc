...
/*
 * 
 * public void setUp(){ System.out.println("I am in before"); }
 * 
 * public void tearDown(){ System.out.println("I am in after"); } public void
 * insertRecordTest(){
 * 
 * MyBusinessLogic mbl = new MyBusinessLogic(); int retVal =
 * mbl.insertRecord(101, "Harry");
 * 
 * assertEquals(1, retVal); }
 * 
 * 
 * public void sayHelloTest(){ MyBusinessLogic mbl = new MyBusinessLogic();
 * String name = "Messi"; String retVal = "Hello" + name;
 * 
 * assertEquals(retVal, mbl.sayHello(name));
 * 
 * 
